...
import {RepaymentListComponent} from './repayments/repayment-list/repayment-list.component';
import {RepaymentFormComponent} from './repayments/repayment-form/repayment-form.component';
...
export const routes: Routes = [
  ...
  { path: 'repayments/create', component: RepaymentFormComponent },
];
